...
const Footer = () => {
    return (
        <footer className=" w-full text-sm text-center relative pb-7 bottom-0 bg-gradient-to-r from-[#2545d4] to-[#6412b6] text-white text-[0.9rem]">    
            <p>
            ...
            {/* <p>
                Weather data provided by <a href="https://www.weatherapi.com/" target="_blank" rel="noopener"
                    classNameNameName="text-[#29acd4] hover:underline">WeatherAPI</a>
            </p> */}
        </footer>
    )
}
